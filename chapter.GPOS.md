<div xmlns="http://www.w3.org/1999/xhtml" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.GPOS"></a>Chapter 23. GPOS - The Glyph Positioning Table</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300710678512"></a>Overview</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.1.1"></a>Specification</h4></div></div></div><p>The Glyph Positioning table (<a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a>)
          ...
          accuracy.</p><div class="figure"><a name="idm300710674816"></a><p class="title"><strong>Figure 23.1. Figure 4a. Vietnamese words with marks.</strong></p><div class="figure-contents"><div class="mediaobject"><img src="src/images/../../fig4a.gif" alt="Figure 4a. Vietnamese words with marks."/></div></div></div><br class="figure-break"/><p>Other writing systems require sophisticated glyph
          ...
          and vertical (Y) positions of each glyph.</p><div class="figure"><a name="idm300710671904"></a><p class="title"><strong>Figure 23.2. Figure 4b. Urdu layout requires glyph positioning
          ...
          attachment points for different diacritical marks.</p><div class="figure"><a name="idm300710656592"></a><p class="title"><strong>Figure 23.4. Base glyph with multiple attachment points.</strong></p><div class="figure-contents"><div class="mediaobject"><img src="src/images/../../attach.gif" alt="Base glyph with multiple attachment points."/></div></div></div><br class="figure-break"/><p>To reduce the size of the font file, a base glyph may
          ...
          attachment points for each glyph (see Figure 4d).</p><div class="figure"><a name="idm300710652768"></a><p class="title"><strong>Figure 23.5. Figure 4d. Entry and exit points marked on contextual
          ...
          of actions for positioning and attaching glyphs:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p>A <span class="emphasis"><em>single adjustment</em></span> positions
            ...
            <span class="emphasis"><em>Chaining Contextual positioning</em></span>
              ...
              performed on "input" context sequences.</p></li></ul></div><div class="figure"><a name="idm300710637888"></a><p class="title"><strong>Figure 23.6. Figure 4e. Contextual positioning lowered the accent
          ...
          works.</p><div class="figure"><a name="idm300710629760"></a><p class="title"><strong>Figure 23.7. Figure 4f. High-level organization of <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a>
          ...
          table:</p><div class="table"><a name="idm300714467024"></a><p class="title"><strong>Table 23.1. LookupType Enumeration table for glyph
          ...
          described at the end of this chapter.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714440768"></a>GPOS Header</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.2.1"></a>Specification</h4></div></div></div><p>The <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a> table begins with a header
          ...
          Header table definition.</p><div class="table"><a name="idm300714436880"></a><p class="title"><strong>Table 23.2. GPOS Header</strong></p><div class="table-contents"><table class="table" summary="GPOS Header" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Fixed</td><td>Version</td><td>Version of the <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a>
              ...
              <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a> table</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div><div role="annotation" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.2.2"></a>Annotation</h4></div></div></div><p>Nothing to note.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714423712"></a>Lookup Type 1: Single Adjustment Positioning Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.3.1"></a>Specification</h4></div></div></div><p>A single adjustment positioning subtable (SinglePos) is
          ...
          glyph.</p></div><div role="annotation" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.3.2"></a>Annotation</h4></div></div></div><p>None</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714418384"></a>Single Adjustment Positioning: Format 1</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.4.1"></a>Specification</h4></div></div></div><p>A SinglePosFormat1 subtable applies the same positioning
	  ...
	  is the glyph id of the matched glyph.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714378480"></a>Lookup Type 2: Pair Adjustment Positioning Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.6.1"></a>Specification</h4></div></div></div><p>A pair adjustment positioning subtable (PairPos) is used
          ...
          that identifies glyphs by class (Format 2).</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714375104"></a>Pair Positioning Adjustment: Format 1</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.7.1"></a>Specification</h4></div></div></div><p>Format 1 uses glyph indices to access positioning data
          ...
          PairValueRecords in the set.</p><div class="table"><a name="idm300714354896"></a><p class="title"><strong>Table 23.6. PairSet table</strong></p><div class="table-contents"><table class="table" summary="PairSet table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>PairValueCount</td><td>Number of PairValueRecords</td><td class="auto-generated"> </td></tr><tr><td>struct</td><td>PairValueRecord
          ...
          kerning.</p><div class="table"><a name="idm300714348304"></a><p class="title"><strong>Table 23.7. PairValueRecord</strong></p><div class="table-contents"><table class="table" summary="PairValueRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>GlyphID</td><td>SecondGlyph</td><td>GlyphID of second glyph in the pair-first
	...
	I<sub>1</sub> ◀, where:
	  ...
	  r.Value2}.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714330544"></a>Pair Positioning Adjustment: Format 2</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.8.1"></a>Specification</h4></div></div></div><p>Format 2 defines a pair as a set of two glyph classes
          ...
          all Class1Records according to class value.</p><div class="blockquote"><blockquote class="blockquote"><p>Note: Class1Records are not tagged with a class value
            ...
            glyph, and so on.</p></blockquote></div><div class="table"><a name="idm300714320416"></a><p class="title"><strong>Table 23.8. PairPosFormat2 subtable: Class pair adjustment</strong></p><div class="table-contents"><table class="table" summary="PairPosFormat2 subtable: Class pair adjustment" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>PosFormat</td><td>Format identifier-format = 2</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Coverage</td><td>Offset to Coverage table - from beginning of
	...
	{ValueFormat2, r.Value2}.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714284416"></a>Lookup Type 3: Cursive Attachment Positioning Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.9.1"></a>Specification</h4></div></div></div><p>Some cursive fonts are designed so that adjacent glyphs
          ...
          (EntryExitRecord).</p><div class="table"><a name="idm300714280432"></a><p class="title"><strong>Table 23.11. CursivePosFormat1 subtable: Cursive attachment</strong></p><div class="table-contents"><table class="table" summary="CursivePosFormat1 subtable: Cursive attachment" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>PosFormat</td><td>Format identifier-format = 1</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Coverage</td><td>Offset to Coverage table - from beginning of
          ...
          glyph attachment in the Urdu language.</p><div class="table"><a name="idm300714270128"></a><p class="title"><strong>Table 23.12. EntryExitRecord</strong></p><div class="table-contents"><table class="table" summary="EntryExitRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Offset</td><td>EntryAnchor</td><td>Offset to EntryAnchor table-from beginning of
	  ...
	  figure out how this lookup type really works.]</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714259712"></a>Lookup Type 4: MarkToBase Attachment Positioning Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.10.1"></a>Specification</h4></div></div></div><p>The MarkToBase attachment (MarkBasePos) subtable is used
          ...
          MarkBasePosFormat1 subtable.</p><div class="table"><a name="idm300714231456"></a><p class="title"><strong>Table 23.15. BaseRecord</strong></p><div class="table-contents"><table class="table" summary="BaseRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Offset</td><td>BaseAnchor [ClassCount]</td><td>Array of offsets (one per class) to Anchor
	  ...
	  [b]].BaseAnchor [MarkArray.MarkRecord[m].Class] of b.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714208576"></a>Lookup Type 5: MarkToLigature Attachment Positioning
        Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.11.1"></a>Specification</h4></div></div></div><p>The MarkToLigature attachment (MarkLigPos) subtable is
          ...
          the LigatureCoverage Index.</p><div class="table"><a name="idm300714186928"></a><p class="title"><strong>Table 23.17. LigatureArray table</strong></p><div class="table-contents"><table class="table" summary="LigatureArray table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>LigatureCount</td><td>Number of LigatureAttach table
          ...
          right to left, the first component is on the right.</p><div class="table"><a name="idm300714180432"></a><p class="title"><strong>Table 23.18. LigatureAttach table</strong></p><div class="table-contents"><table class="table" summary="LigatureAttach table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>ComponentCount</td><td>Number of ComponentRecords in this
          ...
          ligature glyph in the Arabic script.</p><div class="table"><a name="idm300714172832"></a><p class="title"><strong>Table 23.19. ComponentRecord</strong></p><div class="table-contents"><table class="table" summary="ComponentRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Offset</td><td>LigatureAnchor [ClassCount]</td><td>Array of offsets (one per class) to Anchor
	  ...
	  to determine to which component the mark should be attached.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714150592"></a>Lookup Type 6: MarkToMark Attachment Positioning
	  ...
	  may act on it several times, to position them.</p><p>The MarkToMark attachment subtable has one format:
          ...
          end of this chapter.</p><div class="table"><a name="idm300714141648"></a><p class="title"><strong>Table 23.20. MarkMarkPosFormat1 subtable: MarkToMark attachment</strong></p><div class="table-contents"><table class="table" summary="MarkMarkPosFormat1 subtable: MarkToMark attachment" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>PosFormat</td><td>Format identifier-format = 1</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Mark1Coverage</td><td>Offset to Combining Mark Coverage table-from
          ...
          another in the Arabic script.</p><div class="table"><a name="idm300714122240"></a><p class="title"><strong>Table 23.22. Mark2Record</strong></p><div class="table-contents"><table class="table" summary="Mark2Record" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Offset</td><td>Mark2Anchor [ClassCount]</td><td>Array of offsets (one per class) to Anchor
	  ...
	  [m2]].Mark2Anchor [Mark1Array.MarkRecord[m].Class] of m2.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714111808"></a>Lookup Type 7: Contextual Positioning Subtables</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.13.1"></a>Specification</h4></div></div></div><p>A Contextual Positioning (ContextPos) subtable defines
          ...
          PosLookupRecord. A description of that record follows.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714107280"></a>PosLookupRecord</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.14.1"></a>Specification</h4></div></div></div><p>All contextual positioning subtables specify the
          ...
          Examples 10, 11, and 12 show PosLookupRecords.</p><div class="table"><a name="idm300714103616"></a><p class="title"><strong>Table 23.23. PosLookupRecord</strong></p><div class="table-contents"><table class="table" summary="PosLookupRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>SequenceIndex</td><td>Index to input glyph sequence-first glyph =
              0</td><td class="auto-generated"> </td></tr><tr><td>uint16</td><td>LookupListIndex</td><td>Lookup to apply to that
              position-zero-based</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300714097728"></a>Context Positioning Subtable: Format 1</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.15.1"></a>Specification</h4></div></div></div><p>Format 1 defines the context for a glyph positioning
          ...
          (PosRuleCount).</p><div class="table"><a name="idm300714078592"></a><p class="title"><strong>Table 23.25. PosRuleSet table: All contexts beginning with the
          ...
          kerning in context with a ContextPosFormat1 subtable.</p><div class="table"><a name="idm300714070528"></a><p class="title"><strong>Table 23.26. PosRule subtable</strong></p><div class="table-contents"><table class="table" summary="PosRule subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>GlyphCount</td><td>Number of glyphs in the Input glyph
	  ...
	  run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709842992"></a>Context Positioning Subtable: Format 2</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.16.1"></a>Specification</h4></div></div></div><p>Format 2, more flexible than Format 1, describes
          ...
          PosClassSet.</p><div class="table"><a name="idm300709822512"></a><p class="title"><strong>Table 23.28. PosClassSet table: All contexts beginning with the same class</strong></p><div class="table-contents"><table class="table" summary="PosClassSet table: All contexts beginning with the same class" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>PosClassRuleCnt</td><td>Number of PosClassRule tables</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>PosClassRule [PosClassRuleCnt]</td><td>Array of offsets to PosClassRule tables-from
	...
	run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709795616"></a>Context Positioning Subtable: Format 3</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.17.1"></a>Specification</h4></div></div></div><p>Format 3, coverage-based context positioning, defines a
	  ...
	  run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709769312"></a>Lookup Type 8: Chaining Contextual Positioning Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.18.1"></a>Specification</h4></div></div></div><p>A Chaining Contextual Positioning
...
Lookahead sequence                           0   1   2   3<br/>
	  ...
	  LookaheadGlyphCount - 1</em></span>.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709757904"></a>Chaining Context Positioning Format 1: Simple Chaining
        Context Glyph Positioning</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.19.1"></a>Specification</h4></div></div></div><p>This Format is identical to Format 1 of Context
          ...
          PosRuleSet subtables.)</p><div class="table"><a name="idm300709755136"></a><p class="title"><strong>Table 23.31. ChainContextPosFormat1 subtable: Simple context
          ...
          in the set (ChainPosRuleCount).</p><div class="table"><a name="idm300709746016"></a><p class="title"><strong>Table 23.32. ChainPosRuleSet table: All contexts beginning with
	  ...
	  position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709711632"></a>Chaining Context Positioning Format 2: Class-based
        Chaining Context Glyph Positioning</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.20.1"></a>Specification</h4></div></div></div><p>This lookup Format is parallel to the Context
          ...
          Lookahead ClassDef.</p><div class="table"><a name="idm300709708576"></a><p class="title"><strong>Table 23.34. ChainContextPosFormat2 subtable: Chaining class-based context glyph positioning</strong></p><div class="table-contents"><table class="table" summary="ChainContextPosFormat2 subtable: Chaining class-based context glyph positioning" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>PosFormat</td><td>Format identifier-format = 2</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Coverage</td><td>Offset to Coverage table-from beginning of
          ...
          first component.</p><div class="table"><a name="idm300709694576"></a><p class="title"><strong>Table 23.35. ChainPosClassSet table: All contexts beginning with the same class</strong></p><div class="table-contents"><table class="table" summary="ChainPosClassSet table: All contexts beginning with the same class" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>ChainPosClassRuleCnt</td><td>Number of ChainPosClassRule
              ...
              preference</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/><div class="table"><a name="idm300709689056"></a><p class="title"><strong>Table 23.36. ChainPosClassRule subtable</strong></p><div class="table-contents"><table class="table" summary="ChainPosClassRule subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>BacktrackGlyphCount</td><td>Total number of glyphs in the backtrack
              sequence (number of glyphs to be matched before the
	  ...
	  run. Instead, it invokes other lookups at the current
	  position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709659936"></a>Chaining Context Positioning Format 3: Coverage-based Chaining
	  ...
	  does it have an action by itself.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709650672"></a>Shared Tables: ValueRecord, Anchor Table, and MarkArray</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.23.1"></a>Specification</h4></div></div></div><p>Several lookup subtables described earlier in this
          ...
          <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a>.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709646432"></a>ValueRecord</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.24.1"></a>Specification</h4></div></div></div><p>
        <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a> subtables use ValueRecords to
          ...
          from subtable to subtable.</p><div class="table"><a name="idm300709640976"></a><p class="title"><strong>Table 23.39. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>int16</td><td>XPlacement</td><td>Horizontal adjustment for placement-in design
          ...
          definition.</p><div class="table"><a name="idm300709618800"></a><p class="title"><strong>Table 23.40. ValueFormat bit enumeration (indicates which fields
        ...
        (Format 2) or Device tables (Format 3).</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709593792"></a>Anchor Table: Format 1</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.26.1"></a>Specification</h4></div></div></div><p>AnchorFormat1 consists of a format identifier
          ...
          AnchorFormat1.</p><div class="table"><a name="idm300709590736"></a><p class="title"><strong>Table 23.41. AnchorFormat1 table: Design units only</strong></p><div class="table-contents"><table class="table" summary="AnchorFormat1 table: Design units only" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>AnchorFormat</td><td>Format identifier-format = 1</td><td class="auto-generated"> </td></tr><tr><td>int16</td><td>XCoordinate</td><td>Horizontal value-in design
              units</td><td class="auto-generated"> </td></tr><tr><td>int16</td><td>YCoordinate</td><td>Vertical value-in design units</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709583392"></a>Anchor Table: Format 2</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.27.1"></a>Specification</h4></div></div></div><p>Like AnchorFormat1, AnchorFormat2 specifies a format
          ...
          AnchorFormat2.</p><div class="table"><a name="idm300709579744"></a><p class="title"><strong>Table 23.42. AnchorFormat2 table: Design units plus contour
            point</strong></p><div class="table-contents"><table class="table" summary="AnchorFormat2 table: Design units plus contour&#10;            point" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>AnchorFormat</td><td>Format identifier-format = 2</td><td class="auto-generated"> </td></tr><tr><td>int16</td><td>XCoordinate</td><td>Horizontal value-in design
              units</td><td class="auto-generated"> </td></tr><tr><td>int16</td><td>YCoordinate</td><td>Vertical value-in design units</td><td class="auto-generated"> </td></tr><tr><td>uint16</td><td>AnchorPoint</td><td>Index to glyph contour point</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709570896"></a>Anchor Table: Format 3</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.28.1"></a>Specification</h4></div></div></div><p>Like AnchorFormat1, AnchorFormat3 specifies a format
          ...
          AnchorFormat3 table.</p><div class="table"><a name="idm300709567040"></a><p class="title"><strong>Table 23.43. AnchorFormat3 table: Design units plus Device
            tables</strong></p><div class="table-contents"><table class="table" summary="AnchorFormat3 table: Design units plus Device&#10;            tables" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>AnchorFormat</td><td>Format identifier-format = 3</td><td class="auto-generated"> </td></tr><tr><td>int16</td><td>XCoordinate</td><td>Horizontal value-in design
              ...
              beginning of Anchor table (may be NULL)</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709556560"></a>Mark Array</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.29.1"></a>Specification</h4></div></div></div><p>The MarkArray table defines the class and the anchor
          ...
          source, and comments.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709535072"></a>Example 1: GPOS Header Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.31.1"></a>Specification</h4></div></div></div><p>Example 1 shows a typical <a class="link" href="chapter.GPOS.html" title="Chapter 23. GPOS - The Glyph Positioning Table">GPOS</a> Header
          table definition with offsets to a ScriptList, FeatureList,
          and LookupList.</p><div class="table"><a name="idm300709532080"></a><p class="title"><strong>Table 23.46. Example 1</strong></p><div class="table-contents"><table class="table" summary="Example 1" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>GPOSHeader</td><td> </td></tr><tr><td> </td><td>TheGPOSHeader</td><td>GPOSHeader table
                  definition</td></tr><tr><td>00010000</td><td>0x00010000</td><td>Version</td></tr><tr><td>000A</td><td>TheScriptList</td><td>offset to ScriptList table</td></tr><tr><td>001E</td><td>TheFeatureList</td><td>offset to FeatureList table</td></tr><tr><td>002C</td><td>TheLookupList</td><td>offset to LookupList table</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709520816"></a>Example 2: SinglePosFormat1 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.32.1"></a>Specification</h4></div></div></div><p>Example 2 uses the SinglePosFormat1 subtable to lower
          ...
          settings.</p><div class="table"><a name="idm300709493776"></a><p class="title"><strong>Table 23.48. Example 3</strong></p><div class="table-contents"><table class="table" summary="Example 3" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>SinglePosFormat2</td><td> </td></tr><tr><td> </td><td>DashSpacingSubTable</td><td>SinglePos subtable
                  ...
                  definition</td></tr><tr><td>0001</td><td>1</td><td>CoverageFormat</td></tr><tr><td>0003</td><td>3</td><td>GlyphCount</td></tr><tr><td>004F</td><td>DashGlyphID</td><td>GlyphArray[0]</td></tr><tr><td>0125</td><td>EnDashGlyphID</td><td>GlyphArray[1]</td></tr><tr><td>0129</td><td>EmDashGlyphID</td><td>GlyphArray[2]</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709463984"></a>Example 4: PairPosFormat1 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.34.1"></a>Specification</h4></div></div></div><p>Example 4 uses a PairPosFormat1 subtable to kern two
          ...
          and two ValueRecords, one for each glyph.</p><div class="table"><a name="idm300709460400"></a><p class="title"><strong>Table 23.49. Example 4</strong></p><div class="table-contents"><table class="table" summary="Example 4" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>PairPosFormat1</td><td> </td></tr><tr><td> </td><td>PairKerningSubTable</td><td>PairPos subtable
                  ...
                  definition</td></tr><tr><td>0001</td><td>1</td><td>CoverageFormat</td></tr><tr><td>0002</td><td>2</td><td>GlyphCount</td></tr><tr><td>002D</td><td>UppercasePGlyphID</td><td>GlyphArray[0]</td></tr><tr><td>0031</td><td>UppercaseTGlyphID</td><td>GlyphArray[1]</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709419472"></a>Example 5: PairPosFormat2 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.35.1"></a>Specification</h4></div></div></div><p>The PairPosFormat2 subtable in this example defines
          ...
          glyph.</p><div class="table"><a name="idm300709414496"></a><p class="title"><strong>Table 23.50. Example 5</strong></p><div class="table-contents"><table class="table" summary="Example 5" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>PairPosFormat2</td><td> </td></tr><tr><td> </td><td>PunctKerningSubTable</td><td>PairPos subtable
          ...
          baseline.</p><div class="table"><a name="idm300709354048"></a><p class="title"><strong>Table 23.51. Example 6</strong></p><div class="table-contents"><table class="table" summary="Example 6" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>CursivePosFormat1</td><td> </td></tr><tr><td> </td><td>DiagonalWritingSubTable</td><td>CursivePos subtable
          ...
          an attachment point for marks placed below it.</p><div class="table"><a name="idm300709298432"></a><p class="title"><strong>Table 23.52. Example 7</strong></p><div class="table-contents"><table class="table" summary="Example 7" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>MarkBasePosFormat1</td><td> </td></tr><tr><td> </td><td>MarkBaseAttachSubTable</td><td>MarkBasePos subtable
          ...
          hanza base mark.</p><div class="table"><a name="idm300709130112"></a><p class="title"><strong>Table 23.54. Example 9</strong></p><div class="table-contents"><table class="table" summary="Example 9" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>MarkMarkPosFormat1</td><td> </td></tr><tr><td> </td><td>MarkMarkAttachSubTable</td><td>MarkMarkPos subtable
                  ...
                  definition</td></tr><tr><td>0001</td><td>1</td><td>AnchorFormat</td></tr><tr><td>00DD</td><td>221</td><td>XCoordinate</td></tr><tr><td>012D</td><td>301</td><td>Ycoordinate</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300709075936"></a>Example 10: ContextPosFormat1 Subtable and
        PosLookupRecord</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.40.1"></a>Specification</h4></div></div></div><p>Example 10 uses a ContextPosFormat1 subtable to adjust
          ...
          glyphs.</p><div class="table"><a name="idm300709071728"></a><p class="title"><strong>Table 23.55. Example 10</strong></p><div class="table-contents"><table class="table" summary="Example 10" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>ContextPosFormat1</td><td> </td></tr><tr><td> </td><td>MoveHehInSubtable</td><td>ContextPos subtable
          ...
          glyph in position 0 in the context string.</p><div class="table"><a name="idm300709030272"></a><p class="title"><strong>Table 23.56. Example 11</strong></p><div class="table-contents"><table class="table" summary="Example 11" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>ContextPosFormat2</td><td> </td></tr><tr><td> </td><td>MoveAccentsSubtable</td><td>ContextPos subtable
                  ...
                  width</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300708915712"></a>Example 12: ContextPosFormat3 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.42.1"></a>Specification</h4></div></div></div><p>Example 12 uses a ContextPosFormat3 subtable to lower
          ...
          and repositions the math sign.</p><div class="table"><a name="idm300708912336"></a><p class="title"><strong>Table 23.57. Example 12</strong></p><div class="table-contents"><table class="table" summary="Example 12" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>ContextPosFormat3</td><td> </td></tr><tr><td> </td><td>LowerMathSignsSubtable</td><td>ContextPos subtable
          ...
          string.</p><div class="table"><a name="idm300708840240"></a><p class="title"><strong>Table 23.58. Example 13</strong></p><div class="table-contents"><table class="table" summary="Example 13" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>PosLookupRecord</td><td> </td></tr><tr><td> </td><td>PosLookupRecord</td><td>0] PosLookupRecord
                  ...
                  glyph position</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm300708831872"></a>Example 14: ValueFormat Table and ValueRecord</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.24.44.1"></a>Specification</h4></div></div></div><p>Example 14 demonstrates how to specify positioning
