<div xmlns="http://www.w3.org/1999/xhtml" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.GSUB"></a>Chapter 24. GSUB - The Glyph Substitution Table</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759516176"></a>Overview</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.1.1"></a>Specification</h4></div></div></div><p>The Glyph Substitution table (<a class="link" href="chapter.GSUB.html" title="Chapter 24. GSUB - The Glyph Substitution Table">GSUB</a>)
          ...
          2)</p><div class="figure"><a name="idm363759512832"></a><p class="title"><strong>Figure 24.1. Figure 1: Isolated, initial, medial, and final forms
            of the Arabic character HAH</strong></p><div class="figure-contents"><div class="mediaobject"><img src="src/images/../../fig3a.gif" alt="Figure 1: Isolated, initial, medial, and final forms of the Arabic character HAH"/></div></div></div><br class="figure-break"/><div class="figure"><a name="idm363759510688"></a><p class="title"><strong>Figure 24.2. Figure 2. Two Latin glyphs and their associated
          ...
          glyph."</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759504432"></a>Substituting Glyphs with CommonType</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.2.1"></a>Specification</h4></div></div></div><p>The CommonType <a class="link" href="chapter.GSUB.html" title="Chapter 24. GSUB - The Glyph Substitution Table">GSUB</a> table fully
          ...
          typography:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p>A <span class="emphasis"><em>single substitution</em></span> replaces
              ...
              vertical text in the Far East (see Figure 3)</p><div class="figure"><a name="idm363759494896"></a><p class="title"><strong>Figure 24.3. Figure 3. Alternative forms of parentheses used
              ...
              decomposition (see Figure 4)</p><div class="figure"><a name="idm363759491376"></a><p class="title"><strong>Figure 24.4. Figure 4. Decomposing a Latin ligature glyph into
              ...
              the four alternatives (see Figure 5)</p><div class="figure"><a name="idm363759487552"></a><p class="title"><strong>Figure 24.5. Figure 5. Alternative ampersand glyphs in a
              ...
              lookup flags.</p><div class="figure"><a name="idm363759483728"></a><p class="title"><strong>Figure 24.6. Figure 6. Three Arabic glyphs and their
		...
		start.</p></li></ul></div></div><div role="annotation" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.2.2"></a>Annotation</h4></div></div></div><p>The model presented in the first paragraph is too
          ...
          and LookupLists, see the chapter Common Table Formats</p><div class="figure"><a name="idm363759466176"></a><p class="title"><strong>Figure 24.7. Figure 7. High-level organization of <a class="link" href="chapter.GSUB.html" title="Chapter 24. GSUB - The Glyph Substitution Table">GSUB</a>
          ...
          listed in the LookupType Enumeration table:</p><div class="table"><a name="idm363759454400"></a><p class="title"><strong>Table 24.1. LookupType Enumeration table for glyph
		...
		in chaining context</td></tr><tr><td>9+</td><td>Reserved</td><td>For future use</td></tr></tbody></table></div></div><br class="table-break"/><p>Each LookupType subtable has one or more formats. The
          ...
          replaced by 'seven'.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759427152"></a>GSUB header</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.4.1"></a>Specification</h4></div></div></div><p>The <a class="link" href="chapter.GSUB.html" title="Chapter 24. GSUB - The Glyph Substitution Table">GSUB</a> table begins with a header
          ...
          definition.</p><div class="table"><a name="idm363759423280"></a><p class="title"><strong>Table 24.2. GSUB Header</strong></p><div class="table-contents"><table class="table" summary="GSUB Header" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Fixed</td><td>Version</td><td>Version of the <a class="link" href="chapter.GSUB.html" title="Chapter 24. GSUB - The Glyph Substitution Table">GSUB</a>
          ...
          tables:..."</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759409792"></a>Lookup Type 1: Single Substitution Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.5.1"></a>Specification</h4></div></div></div><p>Single substitution (SingleSubst) subtables tell a
          ...
          Format 2, but it is less flexible.</p></div><div role="annotation" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.5.2"></a>Annotation</h4></div></div></div><p>None.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759404912"></a>Single Substitution Format 1</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.6.1"></a>Specification</h4></div></div></div><p>Format 1 calculates the indices of the output glyphs,
          ...
          replace standard numerals with lining numerals.</p><div class="table"><a name="idm363759400992"></a><p class="title"><strong>Table 24.3. SingleSubstFormat1 subtable: Calculated output glyph
	  ...
	  replacement glyph has id (g+DeltaGlyphId) % 0xffff.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759389248"></a>Single Substitution Format 2</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.7.1"></a>Specification</h4></div></div></div><p>Format 2 is more flexible than Format 1, but requires
          ...
          oriented glyphs.</p><div class="table"><a name="idm363759384864"></a><p class="title"><strong>Table 24.4. SingleSubstFormat2 subtable: Specified output glyph
	  ...
	  array.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759372208"></a>LookupType 2: Multiple Substitution Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.8.1"></a>Specification</h4></div></div></div><p>A Multiple Substitution (MultipleSubst) subtable
          ...
          replace a single ligature with three glyphs.</p><div class="table"><a name="idm363759366544"></a><p class="title"><strong>Table 24.5. MultipleSubstFormat1 subtable: Multiple output glyphs</strong></p><div class="table-contents"><table class="table" summary="MultipleSubstFormat1 subtable: Multiple output glyphs" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>SubstFormat</td><td>Format identifier – format = 1</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Coverage</td><td>Offset to Coverage table – from beginning of
              ...
              Index</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/><div class="table"><a name="idm363759357808"></a><p class="title"><strong>Table 24.6. Sequence table</strong></p><div class="table-contents"><table class="table" summary="Sequence table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>GlyphCount</td><td>Number of GlyphIDs in the Substitute array.
	  ...
	  appear in that array.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759348256"></a>LookupType 3: Alternate Substitution Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.9.1"></a>Specification</h4></div></div></div><p>An Alternate Substitution (AlternateSubst) subtable
        ...
        glyphs.</p><div class="table"><a name="idm363759343472"></a><p class="title"><strong>Table 24.7. AlternateSubstFormat1 subtable: Alternative output
          glyphs</strong></p><div class="table-contents"><table class="table" summary="AlternateSubstFormat1 subtable: Alternative output&#10;          glyphs" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>SubstFormat</td><td>Format identifier – format = 1</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Coverage</td><td>Offset to Coverage table – from beginning of
            ...
            Index</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/><div class="table"><a name="idm363759334704"></a><p class="title"><strong>Table 24.8. AlternateSet table</strong></p><div class="table-contents"><table class="table" summary="AlternateSet table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>GlyphCount</td><td>Number of GlyphIDs in the Alternate
	  ...
	  specified.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759323824"></a>LookupType 4: Ligature Substitution Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.10.1"></a>Specification</h4></div></div></div><p>A Ligature Substitution (LigatureSubst) subtable
          ...
          each ligature set.</p><div class="table"><a name="idm363759320544"></a><p class="title"><strong>Table 24.9. LigatureSubstFormat1 subtable: All ligature
          ...
          “ff” Ligature table. </p><div class="table"><a name="idm363759310816"></a><p class="title"><strong>Table 24.10. LigatureSet table: All ligatures beginning with the
        ...
        replace a string of glyphs with a single ligature.</p><div class="table"><a name="idm363759303184"></a><p class="title"><strong>Table 24.11. Ligature table: Glyph components for one
	  ...
	  input sequence by the glyph t.LigGlyph.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759287168"></a>LookupType 5: Contextual Substitution Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.11.1"></a>Specification</h4></div></div></div><p>A Contextual Substitution (ContextSubst) subtable
          ...
          that record follows.</p><div class="table"><a name="idm363759283552"></a><p class="title"><strong>Table 24.12. SubstLookupRecord</strong></p><div class="table-contents"><table class="table" summary="SubstLookupRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>SequenceIndex</td><td>Index into current glyph sequence – first glyph
	...
	ignores some glyphs, should those be ignored?</p><p>The description of the SubstLookupRecord used to be in
        ...
        its own section.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759268448"></a>Context Substitution Format 1</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.12.1"></a>Specification</h4></div></div></div><p>Format 1 defines the context for a glyph substitution
          ...
          and so on.</p><div class="table"><a name="idm363759257664"></a><p class="title"><strong>Table 24.13. ContextSubstFormat1 subtable: Simple context glyph
          ...
          any instances of &lt;abc&gt;.</p><div class="table"><a name="idm363759248432"></a><p class="title"><strong>Table 24.14. SubRuleSet table: All contexts beginning with the
          ...
          sequence.</p><div class="table"><a name="idm363759240048"></a><p class="title"><strong>Table 24.15. SubRule table: One simple context definition</strong></p><div class="table-contents"><table class="table" summary="SubRule table: One simple context definition" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>GlyphCount</td><td>Total number of glyphs in input glyph
	...
	run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759219648"></a>Context Substitution Format 2</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.13.1"></a>Specification</h4></div></div></div><p>Format 2, a more flexible format than Format 1,
          ...
          NULL.</p><div class="table"><a name="idm363759212464"></a><p class="title"><strong>Table 24.16. ContextSubstFormat2 subtable: Class-based context
          ...
          to the entire glyph sequence.</p><div class="table"><a name="idm363759191472"></a><p class="title"><strong>Table 24.18. SubClassRule table: Context definition for one
	...
	run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759171104"></a>Context Substitution Format 3</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.14.1"></a>Specification</h4></div></div></div><p>Format 3, coverage-based context substitution, defines
          ...
          glyphs for two out of three glyphs in a sequence.</p><div class="table"><a name="idm363759160160"></a><p class="title"><strong>Table 24.19. ChainContextSubstFormat3 subtable: Coverage-based
	  ...
	  LookaheadGlyphCount - 1</em></span>.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759134768"></a>Chaining Context Substitution Format 1: Simple Chaining
...
Lookahead sequence -                   0  1  2  3<br/>
          ...
          listed in the Coverage table, and so on.</p><div class="table"><a name="idm363759123536"></a><p class="title"><strong>Table 24.20. ChainContextSubstFormat1 subtable: Simple context
          ...
          without affecting any instances of &lt;abc&gt;.</p><div class="table"><a name="idm363759113120"></a><p class="title"><strong>Table 24.21. ChainSubRuleSet table: All contexts beginning with
          ...
          array should list records in design order, or the order the
          lookups should be applied to the entire glyph
          sequence.</p><div class="table"><a name="idm363759104336"></a><p class="title"><strong>Table 24.22. ChainSubRule subtable</strong></p><div class="table-contents"><table class="table" summary="ChainSubRule subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>BacktrackGlyphCount</td><td>Total number of glyphs in the backtrack
	  ...
	  position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759072176"></a>Chaining Context Substitution Format 2: Class-based Chaining
        Context Glyph Substitution</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.17.1"></a>Specification</h4></div></div></div><p>Format 2 describes class-based chaining context
          ...
          ChainSubClassSet array will be set to NULL.</p><div class="table"><a name="idm363759066320"></a><p class="title"><strong>Table 24.23. ChainContextSubstFormat2 subtable: Class-based
          ...
          ChainSubClassRule array of the ChainSubClassSet.</p><div class="table"><a name="idm363759050816"></a><p class="title"><strong>Table 24.24. ChainSubClassSet subtable</strong></p><div class="table-contents"><table class="table" summary="ChainSubClassSet subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>ChainSubClassRuleCnt</td><td>Number of ChainSubClassRule
          ...
          SubstLookupRecord array lists SubstLookupRecords in design
          order – that is, the order in which lookups should be applied
          to the entire glyph sequence.</p><div class="table"><a name="idm363759042384"></a><p class="title"><strong>Table 24.25. ChainSubClassRule table: Chaining context definition
	  ...
	  run. Instead, it invokes other lookups at the current
	  position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363759011328"></a>Chaining Context Substitution Format 3: Coverage-based Chaining
        Context Glyph Substitution</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.18.1"></a>Specification</h4></div></div></div><p>Format 3 defines a chaining context rule as a sequence
          ...
          (SubstLookupRecord) in design order: that is, the order in
          which lookups should be applied to the entire glyph
          sequence. (SubstLookupRecords are described next.)</p><div class="table"><a name="idm363759006624"></a><p class="title"><strong>Table 24.26. ChainContextSubstFormat3 subtable: Coverage-based
	  ...
	  run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758978672"></a>LookupType 7: Extension Substitution</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.19.1"></a>Specification</h4></div></div></div><p>This lookup provides a mechanism whereby any other
          ...
          “extension” subtable.</p><div class="table"><a name="idm363758974576"></a><p class="title"><strong>Table 24.27. ExtensionSubstFormat1 subtable</strong></p><div class="table-contents"><table class="table" summary="ExtensionSubstFormat1 subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>USHORT</td><td>SubstFormat</td><td>Format identifier. Set to 1.</td><td class="auto-generated"> </td></tr><tr><td>USHORT</td><td>ExtensionLookupType</td><td>Lookup type of subtable referenced by
	  ...
	  does it have an action by itself.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758961904"></a>Lookup Type 8: Reverse Chaining Contextual Single
	Substitution</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.20.1"></a>Specification</h4></div></div></div><p>Reverse Chaining Contextual Single Substitution subtable
	  ...
	  end of this chapter.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758957744"></a>Reverse Chaining Contextual Single Substitution Format 1:
	...
	Substitution.</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.21.1"></a>Specification</h4></div></div></div><p>Format 1 defines a chaining context rule as a sequence
	  ...
	  returned from the Coverage table.</p><div class="table"><a name="idm363758953136"></a><p class="title"><strong>Table 24.28. ReverseChainSingleSubstFormat1 subtable:
	    Coverage-based Reverse Chaining Contextual Single Glyph
	    substitution.</strong></p><div class="table-contents"><table class="table" summary="ReverseChainSingleSubstFormat1 subtable:&#10;&#9;    Coverage-based Reverse Chaining Contextual Single Glyph&#10;&#9;    substitution." border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>uint16</td><td>SubstFormat</td><td>Format identifier ’ format = 1</td><td class="auto-generated"> </td></tr><tr><td>Offset</td><td>Coverage</td><td>Offset to Coverage table - from beginning of
	      ...
	      Coverage Index</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758937968"></a>Substitution Lookup Record</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.22.1"></a>Specification</h4></div></div></div><p>All contextual substitution subtables specify the
          ...
          should be moved back in this section.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758932064"></a>GSUB Subtable Examples</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.23.1"></a>Specification</h4></div></div></div><p>The rest of this chapter describes and illustrates
          ...
          source, and comments.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758927792"></a>Example 1: GSUB Header Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.24.1"></a>Specification</h4></div></div></div><p>Example 1 shows a typical <a class="link" href="chapter.GSUB.html" title="Chapter 24. GSUB - The Glyph Substitution Table">GSUB</a> Header table
          definition.</p><div class="table"><a name="idm363758924864"></a><p class="title"><strong>Table 24.29. Example 1</strong></p><div class="table-contents"><table class="table" summary="Example 1" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>GSUBHeader</td><td> </td></tr><tr><td> </td><td>TheGSUBHeader</td><td>GSUBHeader table
                  definition</td></tr><tr><td>00010000</td><td>0x00010000</td><td>version</td></tr><tr><td>000A</td><td>TheScriptList</td><td>offset to ScriptList table</td></tr><tr><td>001E</td><td>TheFeatureList</td><td>offset to FeatureList table</td></tr><tr><td>002C</td><td>TheLookupList</td><td>offset to LookupList table</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758913600"></a>Example 2: SingleSubstFormat1 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.25.1"></a>Specification</h4></div></div></div><p>Example 2 illustrates the SingleSubstFormat1 subtable,
          ...
          (zero) glyph and an EndGlyphID for the "9" glyph.</p><div class="table"><a name="idm363758910704"></a><p class="title"><strong>Table 24.30. Example 2</strong></p><div class="table-contents"><table class="table" summary="Example 2" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>SingleSubstFormat1</td><td> </td></tr><tr><td> </td><td>LiningNumeralSubtable</td><td>SingleSubst subtable
          ...
          glyphs).</p><div class="table"><a name="idm363758888880"></a><p class="title"><strong>Table 24.31. Example 3</strong></p><div class="table-contents"><table class="table" summary="Example 3" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>SingleSubstFormat2</td><td> </td></tr><tr><td> </td><td>VerticalPunctuationSubtable</td><td>SingleSubst
          ...
          Sequence table offsets.</p><div class="table"><a name="idm363758859472"></a><p class="title"><strong>Table 24.32. Example 4</strong></p><div class="table-contents"><table class="table" summary="Example 4" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>MultipleSubstFormat1</td><td> </td></tr><tr><td> </td><td>FfiDecompSubtable</td><td>MultipleSubst subtable
                  ...
                  definition</td></tr><tr><td>0003</td><td>3</td><td>GlyphCount</td></tr><tr><td>001A</td><td>fGlyphID</td><td>first glyph in sequence order</td></tr><tr><td>001A</td><td>fGlyphID</td><td>second glyph</td></tr><tr><td>001D</td><td>iGlyphID</td><td>third glyph</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758832880"></a>Example 5: AlternateSubstFormat 1 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.28.1"></a>Specification</h4></div></div></div><p>Example 5 uses the AlternateSubstFormat1 subtable to
          ...
          default ampersand glyph in the Coverage table.</p><div class="table"><a name="idm363758829120"></a><p class="title"><strong>Table 24.33. Example 5</strong></p><div class="table-contents"><table class="table" summary="Example 5" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>AlternateSubstFormat1</td><td> </td></tr><tr><td> </td><td>AltAmpersandSubtable</td><td>AlternateSubstFormat1
                  ...
                  order</td></tr><tr><td>00CA</td><td>AltAmpersand2GlyphID</td><td>offset to Alternate[1]</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758803936"></a>Example 6: LigatureSubstFormat1 Subtable</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.29.1"></a>Specification</h4></div></div></div><p>Example 6 shows a LigatureSubstFormat1 subtable that
          ...
          ligature.</p><div class="table"><a name="idm363758798496"></a><p class="title"><strong>Table 24.34. Example 6</strong></p><div class="table-contents"><table class="table" summary="Example 6" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>LigatureSubstFormat1</td><td> </td></tr><tr><td> </td><td>LigaturesSubtable</td><td>LigatureSubstFormat1 subtable
                  ...
                  ligature</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758739568"></a>Example 7: ContextSubstFormat1 Subtable and
        SubstLookupRecord</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.30.1"></a>Specification</h4></div></div></div><p>Example 7 uses a ContextSubstFormat1 subtable for glyph
          ...
          replaces the SpaceGlyph with a ThinSpaceGlyph.</p><div class="table"><a name="idm363758735168"></a><p class="title"><strong>Table 24.35. Example 7</strong></p><div class="table-contents"><table class="table" summary="Example 7" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>ContextSubstFormat1</td><td> </td></tr><tr><td> </td><td>DashSubtable</td><td>ContextSubstFormat1 subtable
                  ...
                  SpaceToThinSpaceLookup</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363758682976"></a>Example 8: ContextSubstFormat2 Subtable </h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.25.31.1"></a>Specification</h4></div></div></div><p>Example 8 uses a ContextSubstFormat2 subtable with glyph
          ...
          glyph with a swash descender glyph.</p><div class="table"><a name="idm363757528608"></a><p class="title"><strong>Table 24.37. Example 9</strong></p><div class="table-contents"><table class="table" summary="Example 9" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>HexData</th><th>Source</th><th>Comment</th></tr></thead><tbody><tr><td> </td><td>ContextSubstFormat3</td><td> </td></tr><tr><td> </td><td>SwashSubtable</td><td>ContextSubstFormat3 subtable
                  ...
                  definition</td></tr><tr><td>0001</td><td>1</td><td>CoverageFormat, lists</td></tr><tr><td>0005</td><td>5</td><td>GlyphCount</td></tr><tr><td>0038</td><td>gGlyphID</td><td>GlyphArray[0] in GlyphID order</td></tr><tr><td>003B</td><td>jGlyphID</td><td>GlyphArray[1]</td></tr><tr><td>0041</td><td>pGlyphID</td><td>GlyphArray[2]</td></tr><tr><td>0042</td><td>qGlyphID</td><td>GlyphArray[3]</td></tr><tr><td>004A</td><td>yGlyphID</td><td>GlyphArray[4]</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363757445424"></a>Example 10: ReverseChainSingleSubstFormat1 Subtable
