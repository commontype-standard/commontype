<div xmlns="http://www.w3.org/1999/xhtml" role="" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.GSUB"></a>Chapter 25. GSUB - The Glyph Substitution Table</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320130047232"></a>Overview</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.1.1"></a>Specification</h3></div></div></div><p role="">The Glyph Substitution table (<a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a>)
          ...
          2)</p><div class="figure"><a name="idm320130043904"></a><p class="title"><strong>Figure 25.1. Figure 1: Isolated, initial, medial, and final forms
            of the Arabic character HAH</strong></p><div class="figure-contents"><div role="" class="mediaobject"><img src="src/images/fig3a.gif" alt="Figure 1: Isolated, initial, medial, and final forms of the Arabic character HAH"/></div></div></div><br class="figure-break"/><div class="figure"><a name="idm320130041760"></a><p class="title"><strong>Figure 25.2. Figure 2. Two Latin glyphs and their associated
          ...
          glyph."</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320130035504"></a>Substituting Glyphs with OpenType</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.2.1"></a>Specification</h3></div></div></div><p role="">The OpenType <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table fully
          supports glyph substitution. To access glyph substitutes,
          <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> maps from the glyph index or indices
          ...
          these glyphs. In <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a>, the indices of the
          other ampersand glyphs are then referenced by this one
          index.</p><p role="">The text-processing client uses the
          <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> data to manage glyph substitution
          actions. <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> identifies the glyphs that
          ...
          or language system represented in a font.</p><p role="">The <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table supports six types of glyph
          ...
          typography:</p><div role="" class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li role="" class="listitem"><p role="">A <span role="" class="emphasis"><em>single substitution</em></span> replaces
              ...
              vertical text in the Far East (see Figure 3)</p><div class="figure"><a name="idm320130025968"></a><p class="title"><strong>Figure 25.3. Figure 3. Alternative forms of parentheses used
              ...
              decomposition (see Figure 4)</p><div class="figure"><a name="idm320130022448"></a><p class="title"><strong>Figure 25.4. Figure 4. Decomposing a Latin ligature glyph into
              ...
              the four alternatives (see Figure 5)</p><div class="figure"><a name="idm320130018624"></a><p class="title"><strong>Figure 25.5. Figure 5. Alternative ampersand glyphs in a
              ...
              lookup flags.</p><div class="figure"><a name="idm320130014304"></a><p class="title"><strong>Figure 25.6. Figure 6. Three Arabic glyphs and their
		...
		start.</p></li></ul></div></div><div role="annotation" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.2.2"></a>Annotation</h3></div></div></div><p role="">The model presented in the first paragraph is too
          ...
          necessary for large GSUB tables.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320130853840"></a>Table Organization</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.3.1"></a>Specification</h3></div></div></div><p role="">The <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table begins with a header
          ...
          and LookupLists, see the chapter Common Table Formats</p><div class="figure"><a name="idm320130847232"></a><p class="title"><strong>Figure 25.7. Figure 7. High-level organization of <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a>
          ...
          particular script or language system. To access <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a>
          ...
          procedure:</p><div role="" class="orderedlist"><ol class="orderedlist" type="1"><li role="" class="listitem"><p role="">Locate the current script in the
              <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> ScriptList table.</p></li><li role="" class="listitem"><p role="">If the language system is known, search the script
              ...
              <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> FeatureList table to access a
              ...
              <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> LookupList table.</p></li><li role="" class="listitem"><p role="">Assemble all lookups from the set of chosen
          ...
          listed in the LookupType Enumeration table:</p><div class="table"><a name="idm320129995888"></a><p class="title"><strong>Table 25.1. LookupType Enumeration table for glyph
		...
		in chaining context</td></tr><tr><td role="">9+</td><td role="">Reserved</td><td role="">For future use</td></tr></tbody></table></div></div><br class="table-break"/><p role="">Each LookupType subtable has one or more formats. The
          ...
          <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> header and the subtables defined for
          each <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> LookupType. Examples at the end
          ...
          replaced by 'seven'.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320134793824"></a>GSUB header</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.4.1"></a>Specification</h3></div></div></div><p role="">The <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table begins with a header
          ...
          this chapter shows a <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> Header table
          definition.</p><div class="table"><a name="idm320134789952"></a><p class="title"><strong>Table 25.2. GSUB Header</strong></p><div class="table-contents"><table role="" class="table" summary="GSUB Header" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">Fixed</td><td role="">Version</td><td role="">Version of the <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a>
              ...
              <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table</td><td class="auto-generated"> </td></tr><tr><td role="">Offset</td><td role="">FeatureList</td><td role="">Offset to FeatureList table – from beginning of
              <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table</td><td class="auto-generated"> </td></tr><tr><td role="">Offset</td><td role="">LookupList</td><td role="">Offset to LookupList table – from beginning of
              <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div><div role="annotation" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.4.2"></a>Annotation</h3></div></div></div><p role="">There is a typo in the first sentence "... to a three
          tables:..."</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320134776464"></a>Lookup Type 1: Single Substitution Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.5.1"></a>Specification</h3></div></div></div><p role="">Single substitution (SingleSubst) subtables tell a
          ...
          replace standard numerals with lining numerals.</p><div class="table"><a name="idm320132872512"></a><p class="title"><strong>Table 25.3. SingleSubstFormat1 subtable: Calculated output glyph
	  ...
	  replacement glyph has id (g+DeltaGlyphId) % 0xffff.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132860256"></a>Single Substitution Format 2</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.7.1"></a>Specification</h3></div></div></div><p role="">Format 2 is more flexible than Format 1, but requires
          ...
          oriented glyphs.</p><div class="table"><a name="idm320132855872"></a><p class="title"><strong>Table 25.4. SingleSubstFormat2 subtable: Specified output glyph
	  ...
	  array.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132842704"></a>LookupType 2: Multiple Substitution Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.8.1"></a>Specification</h3></div></div></div><p role="">A Multiple Substitution (MultipleSubst) subtable
          ...
          replace a single ligature with three glyphs.</p><div class="table"><a name="idm320132837040"></a><p class="title"><strong>Table 25.5. MultipleSubstFormat1 subtable: Multiple output glyphs</strong></p><div class="table-contents"><table role="" class="table" summary="MultipleSubstFormat1 subtable: Multiple output glyphs" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">SubstFormat</td><td role="">Format identifier – format = 1</td><td class="auto-generated"> </td></tr><tr><td role="">Offset</td><td role="">Coverage</td><td role="">Offset to Coverage table – from beginning of
              ...
              Index</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/><div class="table"><a name="idm320132828304"></a><p class="title"><strong>Table 25.6. Sequence table</strong></p><div class="table-contents"><table role="" class="table" summary="Sequence table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">GlyphCount</td><td role="">Number of GlyphIDs in the Substitute array.
	  ...
	  appear in that array.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132818240"></a>LookupType 3: Alternate Substitution Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.9.1"></a>Specification</h3></div></div></div><p role="">An Alternate Substitution (AlternateSubst) subtable
        ...
        glyphs.</p><div class="table"><a name="idm320132813456"></a><p class="title"><strong>Table 25.7. AlternateSubstFormat1 subtable: Alternative output
          glyphs</strong></p><div class="table-contents"><table role="" class="table" summary="AlternateSubstFormat1 subtable: Alternative output&#10;          glyphs" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">SubstFormat</td><td role="">Format identifier – format = 1</td><td class="auto-generated"> </td></tr><tr><td role="">Offset</td><td role="">Coverage</td><td role="">Offset to Coverage table – from beginning of
            ...
            Index</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/><div class="table"><a name="idm320132804688"></a><p class="title"><strong>Table 25.8. AlternateSet table</strong></p><div class="table-contents"><table role="" class="table" summary="AlternateSet table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">GlyphCount</td><td role="">Number of GlyphIDs in the Alternate
	  ...
	  specified.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132793296"></a>LookupType 4: Ligature Substitution Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.10.1"></a>Specification</h3></div></div></div><p role="">A Ligature Substitution (LigatureSubst) subtable
          ...
          each ligature set.</p><div class="table"><a name="idm320132790016"></a><p class="title"><strong>Table 25.9. LigatureSubstFormat1 subtable: All ligature
          ...
          “ff” Ligature table. </p><div class="table"><a name="idm320132780288"></a><p class="title"><strong>Table 25.10. LigatureSet table: All ligatures beginning with the
        ...
        replace a string of glyphs with a single ligature.</p><div class="table"><a name="idm320134766864"></a><p class="title"><strong>Table 25.11. Ligature table: Glyph components for one
	  ...
	  input sequence by the glyph t.LigGlyph.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129987808"></a>LookupType 5: Contextual Substitution Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.11.1"></a>Specification</h3></div></div></div><p role="">A Contextual Substitution (ContextSubst) subtable
          ...
          that record follows.</p><div class="table"><a name="idm320129984096"></a><p class="title"><strong>Table 25.12. SubstLookupRecord</strong></p><div class="table-contents"><table role="" class="table" summary="SubstLookupRecord" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">SequenceIndex</td><td role="">Index into current glyph sequence – first glyph
	...
	ignores some glyphs, should those be ignored?</p><p role="">The description of the SubstLookupRecord used to be in
        ...
        its own section.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129968992"></a>Context Substitution Format 1</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.12.1"></a>Specification</h3></div></div></div><p role="">Format 1 defines the context for a glyph substitution
          ...
          and so on.</p><div class="table"><a name="idm320129958208"></a><p class="title"><strong>Table 25.13. ContextSubstFormat1 subtable: Simple context glyph
          ...
          any instances of &lt;abc&gt;.</p><div class="table"><a name="idm320129948976"></a><p class="title"><strong>Table 25.14. SubRuleSet table: All contexts beginning with the
          ...
          sequence.</p><div class="table"><a name="idm320129941120"></a><p class="title"><strong>Table 25.15. SubRule table: One simple context definition</strong></p><div class="table-contents"><table role="" class="table" summary="SubRule table: One simple context definition" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">GlyphCount</td><td role="">Total number of glyphs in input glyph
	...
	run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129919056"></a>Context Substitution Format 2</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.13.1"></a>Specification</h3></div></div></div><p role="">Format 2, a more flexible format than Format 1,
          ...
          NULL.</p><div class="table"><a name="idm320129911872"></a><p class="title"><strong>Table 25.16. ContextSubstFormat2 subtable: Class-based context
          ...
          to the entire glyph sequence.</p><div class="table"><a name="idm320129891184"></a><p class="title"><strong>Table 25.18. SubClassRule table: Context definition for one
	...
	run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129869152"></a>Context Substitution Format 3</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.14.1"></a>Specification</h3></div></div></div><p role="">Format 3, coverage-based context substitution, defines
          ...
          glyphs for two out of three glyphs in a sequence.</p><div class="table"><a name="idm320129858208"></a><p class="title"><strong>Table 25.19. ChainContextSubstFormat3 subtable: Coverage-based
	  ...
	  run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129839696"></a>Lookup Type 6: Chaining Contextual Substitution Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.15.1"></a>Specification</h3></div></div></div><p role="">A Chaining Contextual Substitution subtable
	  ...
	  LookaheadGlyphCount - 1</em></span>.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129831536"></a>Chaining Context Substitution Format 1: Simple Chaining
...
Lookahead sequence -                   0  1  2  3<br/>
          ...
          listed in the Coverage table, and so on.</p><div class="table"><a name="idm320134738624"></a><p class="title"><strong>Table 25.20. ChainContextSubstFormat1 subtable: Simple context
          ...
          without affecting any instances of &lt;abc&gt;.</p><div class="table"><a name="idm320132770112"></a><p class="title"><strong>Table 25.21. ChainSubRuleSet table: All contexts beginning with
          ...
          array should list records in design order, or the order the
          lookups should be applied to the entire glyph
          sequence.</p><div class="table"><a name="idm320132761632"></a><p class="title"><strong>Table 25.22. ChainSubRule subtable</strong></p><div class="table-contents"><table role="" class="table" summary="ChainSubRule subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">BacktrackGlyphCount</td><td role="">Total number of glyphs in the backtrack
	  ...
	  position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129455360"></a>Chaining Context Substitution Format 2: Class-based Chaining
        Context Glyph Substitution</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.17.1"></a>Specification</h3></div></div></div><p role="">Format 2 describes class-based chaining context
          ...
          ChainSubClassSet array will be set to NULL.</p><div class="table"><a name="idm320130844096"></a><p class="title"><strong>Table 25.23. ChainContextSubstFormat2 subtable: Class-based
          ...
          ChainSubClassRule array of the ChainSubClassSet.</p><div class="table"><a name="idm320132736304"></a><p class="title"><strong>Table 25.24. ChainSubClassSet subtable</strong></p><div class="table-contents"><table role="" class="table" summary="ChainSubClassSet subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">ChainSubClassRuleCnt</td><td role="">Number of ChainSubClassRule
          ...
          SubstLookupRecord array lists SubstLookupRecords in design
          order – that is, the order in which lookups should be applied
          to the entire glyph sequence.</p><div class="table"><a name="idm320132727872"></a><p class="title"><strong>Table 25.25. ChainSubClassRule table: Chaining context definition
	  ...
	  run. Instead, it invokes other lookups at the current
	  position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132693616"></a>Chaining Context Substitution Format 3: Coverage-based Chaining
        Context Glyph Substitution</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.18.1"></a>Specification</h3></div></div></div><p role="">Format 3 defines a chaining context rule as a sequence
          ...
          (SubstLookupRecord) in design order: that is, the order in
          which lookups should be applied to the entire glyph
          sequence. (SubstLookupRecords are described next.)</p><div class="table"><a name="idm320132688912"></a><p class="title"><strong>Table 25.26. ChainContextSubstFormat3 subtable: Coverage-based
	  ...
	  run. Instead, it invokes other lookups at the current position.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132658144"></a>LookupType 7: Extension Substitution</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.19.1"></a>Specification</h3></div></div></div><p role="">This lookup provides a mechanism whereby any other
          lookup type's subtables are stored at a 32-bit offset
          location in the <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table. This is
          needed if the total size of the subtables exceeds the 16-bit
          limits of the various other offsets in the
          <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> table. In this specification, the
          subtable stored at the 32-bit offset location is termed the
          “extension” subtable.</p><div class="table"><a name="idm320132654048"></a><p class="title"><strong>Table 25.27. ExtensionSubstFormat1 subtable</strong></p><div class="table-contents"><table role="" class="table" summary="ExtensionSubstFormat1 subtable" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">USHORT</td><td role="">SubstFormat</td><td role="">Format identifier. Set to 1.</td><td class="auto-generated"> </td></tr><tr><td role="">USHORT</td><td role="">ExtensionLookupType</td><td role="">Lookup type of subtable referenced by
	  ...
	  does it have an action by itself.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132641376"></a>Lookup Type 8: Reverse Chaining Contextual Single
	Substitution</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.20.1"></a>Specification</h3></div></div></div><p role="">Reverse Chaining Contextual Single Substitution subtable
	  ...
	  end of this chapter.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320132637216"></a>Reverse Chaining Contextual Single Substitution Format 1:
	...
	Substitution.</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.21.1"></a>Specification</h3></div></div></div><p role="">Format 1 defines a chaining context rule as a sequence
	  ...
	  returned from the Coverage table.</p><div class="table"><a name="idm320128421984"></a><p class="title"><strong>Table 25.28. ReverseChainSingleSubstFormat1 subtable:
	    Coverage-based Reverse Chaining Contextual Single Glyph
	    substitution.</strong></p><div class="table-contents"><table role="" class="table" summary="ReverseChainSingleSubstFormat1 subtable:&#10;&#9;    Coverage-based Reverse Chaining Contextual Single Glyph&#10;&#9;    substitution." border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">uint16</td><td role="">SubstFormat</td><td role="">Format identifier ’ format = 1</td><td class="auto-generated"> </td></tr><tr><td role="">Offset</td><td role="">Coverage</td><td role="">Offset to Coverage table - from beginning of
	      ...
	      Coverage Index</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320128406880"></a>Substitution Lookup Record</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.22.1"></a>Specification</h3></div></div></div><p role="">All contextual substitution subtables specify the
          ...
          should be moved back in this section.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320128401408"></a>GSUB Subtable Examples</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.23.1"></a>Specification</h3></div></div></div><p role="">The rest of this chapter describes and illustrates
          examples of all the <a role="" class="link" href="chapter.GSUB.md" title="Chapter 25. GSUB - The Glyph Substitution Table">GSUB</a> subtables,
          ...
          (zero) glyph and an EndGlyphID for the "9" glyph.</p><div class="table"><a name="idm320128380048"></a><p class="title"><strong>Table 25.30. Example 2</strong></p><div class="table-contents"><table role="" class="table" summary="Example 2" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th role="">HexData</th><th role="">Source</th><th role="">Comment</th></tr></thead><tbody><tr><td role=""> </td><td role="">SingleSubstFormat1</td><td role=""> </td></tr><tr><td role=""> </td><td role="">LiningNumeralSubtable</td><td role="">SingleSubst subtable
          ...
          glyphs).</p><div class="table"><a name="idm320128358256"></a><p class="title"><strong>Table 25.31. Example 3</strong></p><div class="table-contents"><table role="" class="table" summary="Example 3" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th role="">HexData</th><th role="">Source</th><th role="">Comment</th></tr></thead><tbody><tr><td role=""> </td><td role="">SingleSubstFormat2</td><td role=""> </td></tr><tr><td role=""> </td><td role="">VerticalPunctuationSubtable</td><td role="">SingleSubst
          ...
          default ampersand glyph in the Coverage table.</p><div class="table"><a name="idm320129819600"></a><p class="title"><strong>Table 25.33. Example 5</strong></p><div class="table-contents"><table role="" class="table" summary="Example 5" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th role="">HexData</th><th role="">Source</th><th role="">Comment</th></tr></thead><tbody><tr><td role=""> </td><td role="">AlternateSubstFormat1</td><td role=""> </td></tr><tr><td role=""> </td><td role="">AltAmpersandSubtable</td><td role="">AlternateSubstFormat1
                  ...
                  order</td></tr><tr><td role="">00CA</td><td role="">AltAmpersand2GlyphID</td><td role="">offset to Alternate[1]</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129800464"></a>Example 6: LigatureSubstFormat1 Subtable</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.29.1"></a>Specification</h3></div></div></div><p role="">Example 6 shows a LigatureSubstFormat1 subtable that
          ...
          ligature.</p><div class="table"><a name="idm320129795024"></a><p class="title"><strong>Table 25.34. Example 6</strong></p><div class="table-contents"><table role="" class="table" summary="Example 6" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th role="">HexData</th><th role="">Source</th><th role="">Comment</th></tr></thead><tbody><tr><td role=""> </td><td role="">LigatureSubstFormat1</td><td role=""> </td></tr><tr><td role=""> </td><td role="">LigaturesSubtable</td><td role="">LigatureSubstFormat1 subtable
                  ...
                  ligature</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129736096"></a>Example 7: ContextSubstFormat1 Subtable and
        SubstLookupRecord</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.30.1"></a>Specification</h3></div></div></div><p role="">Example 7 uses a ContextSubstFormat1 subtable for glyph
          ...
          replaces the SpaceGlyph with a ThinSpaceGlyph.</p><div class="table"><a name="idm320129731696"></a><p class="title"><strong>Table 25.35. Example 7</strong></p><div class="table-contents"><table role="" class="table" summary="Example 7" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th role="">HexData</th><th role="">Source</th><th role="">Comment</th></tr></thead><tbody><tr><td role=""> </td><td role="">ContextSubstFormat1</td><td role=""> </td></tr><tr><td role=""> </td><td role="">DashSubtable</td><td role="">ContextSubstFormat1 subtable
                  ...
                  SpaceToThinSpaceLookup</td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm320129717184"></a>Example 8: ContextSubstFormat2 Subtable </h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.25.31.1"></a>Specification</h3></div></div></div><p role="">Example 8 uses a ContextSubstFormat2 subtable with glyph
