<div xmlns="http://www.w3.org/1999/xhtml" role="" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.cmap"></a>Chapter 5. cmap - Character to Glyph Index Mapping Table</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630277072"></a>Introduction</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.1.1"></a>Specification</h3></div></div></div><p role="">This table defines the mapping of character codes to the
	  ...
	  looks like:</p><div class="table"><a name="idm114630239648"></a><p class="title"><strong>Table 5.3. Encoding Record</strong></p><div class="table-contents"><table role="" class="table" summary="Encoding Record" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">USHORT</td><td role="">platformID</td><td role="">Platform ID.</td><td class="auto-generated"> </td></tr><tr><td role="">USHORT</td><td role="">encodingID</td><td role="">Platform-specific encoding ID.</td><td class="auto-generated"> </td></tr><tr><td role="">ULONG</td><td role="">offset</td><td role="">Byte offset from beginning of table to the
        ...
        subtables</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.3.1"></a>Specification</h3></div></div></div><p role="">This field must be set to zero for all
          ...
          encoding.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630212768"></a>Format 0: Byte encoding table</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.4.1"></a>Specification</h3></div></div></div><p role="">This is the Apple standard character to glyph index
          mapping table.</p><div class="table"><a name="idm114630210560"></a><p class="title"><strong>Table 5.4. </strong></p><div class="table-contents"><table role="" class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">USHORT</td><td role="">format</td><td role="">Format number is set to 0.</td><td class="auto-generated"> </td></tr><tr><td role="">USHORT</td><td role="">length</td><td role="">This is the length in bytes of the
          ...
          256).</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630196336"></a>Format 2: High-byte mapping through table </h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.5.1"></a>Specification</h3></div></div></div><p role="">This subtable is useful for the national character code
        ...
        their version would already be a vast improvement.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630168064"></a>Format 4: Segment mapping to delta values</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.6.1"></a>Specification</h3></div></div></div><p role="">This is the Microsoft standard character to glyph index
...
...and so on.<br/>
        ...
        should be removed?</p><p role="">It seems a necessary property of this format that the
          ...
          glyphs other than the first 256 glyphs.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630078800"></a>Supporting 4-byte character codes</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.8.1"></a>Specification</h3></div></div></div><p role="">While the four existing <a role="" class="link" href="chapter.cmap.md" title="Chapter 5. cmap - Character to Glyph Index Mapping Table">cmap</a> subtable formats which
        ...
        comma.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630071920"></a>Format 8: mixed 16-bit and 32-bit coverage</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.9.1"></a>Specification</h3></div></div></div><p role="">Format 8 is a bit like format 2, in that it provides for
          ...
          following format:</p><div class="table"><a name="idm114630055376"></a><p class="title"><strong>Table 5.10. </strong></p><div class="table-contents"><table role="" class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">ULONG</td><td role=""> startCharCode</td><td role=""> First character code in this group; note
...
If the intent is really for a Unicode encodings,
        ...
        in bytes of the subtable."</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114630022128"></a>Format 12: Segmented coverage</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.11.1"></a>Specification</h3></div></div></div><p role="">This is the Microsoft standard character to glyph index
          ...
          following format:</p><div class="table"><a name="idm114630007776"></a><p class="title"><strong>Table 5.13. </strong></p><div class="table-contents"><table role="" class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th role="">Type</th><th role="">Name</th><th role="">Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td role="">ULONG</td><td role="">startCharCode</td><td role="">First character code in this group
          ...
          the description of the length field should be "This is the
          length in bytes of the subtable."</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114629997408"></a>Format 14: Unicode Variation Sequences</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.5.12.1"></a>Specification</h3></div></div></div><p role="">Subtable format 14 specifies the Unicode Variation
        ...
        variants by default, it will:</p><div role="" class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li role="" class="listitem"><p role="">encode glyph ID 1142 at U+82A6 in the Unicode cmap
            ...
            UVS cmap subtables Non-Default UVS Table </p></li></ul></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm114629940704"></a>Various test fonts</h2></div></div></div></div></div>