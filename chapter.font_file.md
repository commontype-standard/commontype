<div xmlns="http://www.w3.org/1999/xhtml" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.font_file"></a>Chapter 2. The CommonType Font File</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm504619010832"></a></h3></div></div></div><div role="specification" class="section"><div class="titlepage"/><p>A CommonType font file contains data, structured as a
          ...
          data is specific to the glyph representation format.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm504619005760"></a>Filenames</h3></div></div></div><div role="specification" class="section"><div class="titlepage"/><p>CommonType font files must have either the extension
          ...
          </p></li></ul></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm504618995216"></a>Data Types</h3></div></div></div><div role="specification" class="section"><div class="titlepage"/><p>The following data types are used in the CommonType font
...
return Sum;
        ...
        files.</p><div role="fragment" class="section"><div class="titlepage"><div><div><h5 class="title"><a name="idm504618862336"></a>The TTC File Structure</h5></div></div></div><div role="specification" class="section"><div class="titlepage"/><p>A TrueType Collection file consists of a single
            ...
            Table</em></span>.
          </p><div class="table"><a name="idm504618829328"></a><p class="title"><strong>Table 2.3. TTC Header Version 1.0</strong></p><div class="table-contents"><table class="table" summary="TTC Header Version 1.0" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>Tag</td><td>TTCTag</td><td>TrueType Collection ID string:
