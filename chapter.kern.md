<div xmlns="http://www.w3.org/1999/xhtml" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.kern"></a>Chapter 32. kern - Kerning</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363756478512"></a>Overview</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.33.1.1"></a>Specification</h4></div></div></div><p>Note: Apple has extended the definition of the
	...
	<a class="link" href="chapter.kern.html" title="Chapter 32. kern - Kerning">kern</a> table format specified here.</p><p>The kerning table contains the values that control the
        ...
        subtables present, and the subtables themselves.</p><div class="table"><a name="idm363756471136"></a><p class="title"><strong>Table 32.1. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>USHORT</td><td>version</td><td>Table version number (starts at
        ...
        the kind of information it contains:</p><div class="table"><a name="idm363756465520"></a><p class="title"><strong>Table 32.2. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>USHORT</td><td>version</td><td>Kern subtable version number</td><td class="auto-generated"> </td></tr><tr><td>USHORT</td><td>length</td><td>Length of the subtable, in bytes (including
        ...
        sub-fields, with sizes given in bits:</p><div class="table"><a name="idm363756458480"></a><p class="title"><strong>Table 32.3. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>0</td><td>1</td><td>1 if table has horizontal data, 0 if
		...
		cross-stream kerning back to 0.</p>
              ...
              reserved for future use.</td><td class="auto-generated"> </td></tr></tbody></table></div></div><br class="table-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363756444656"></a>Format 0</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.33.2.1"></a>Specification</h4></div></div></div><p>This is the only format that will be properly
          ...
          list:</p><div class="table"><a name="idm363756441776"></a><p class="title"><strong>Table 32.4. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>USHORT</td><td>nPairs</td><td>This gives the number of kerning pairs in the
          ...
          values. Each has the following format:</p><div class="table"><a name="idm363756432688"></a><p class="title"><strong>Table 32.5. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>USHORT</td><td>left</td><td>The glyph index for the left-hand glyph in
	...
	the value rangeShift.</p><p>Windows v3.1 does not make use of the
        ...
        applications through the GetFontData() API.Format 2 </p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm363756422800"></a>Format 2</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.33.3.1"></a>Specification</h4></div></div></div><p>This subtable is a two-dimensional array of kerning
          ...
          format:</p><div class="table"><a name="idm363756418624"></a><p class="title"><strong>Table 32.6. </strong></p><div class="table-contents"><table class="table" border="1"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Type</th><th>Name</th><th>Description</th><td class="auto-generated"> </td></tr></thead><tbody><tr><td>USHORT</td><td>rowWidth</td><td>The width, in bytes, of a row in the
