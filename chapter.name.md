<div xmlns="http://www.w3.org/1999/xhtml" role="" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.name"></a>Chapter 10. name - Naming Table</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="idm383057211168"></a>Introduction</h2></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="section.10.1.1"></a>Specification</h3></div></div></div><p role="">The naming table allows multilingual strings to be
          ...
          name ID.</p><div class="table"><a name="idm383057184144"></a><p class="title"><strong>Table 10.3. Platform IDs, Platform-specific encoding IDs and
