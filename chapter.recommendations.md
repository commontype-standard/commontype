<div xmlns="http://www.w3.org/1999/xhtml" class="chapter"><div class="titlepage"><div><div><h2 class="title"><a name="chapter.recommendations"></a>Chapter 39. Recommendations for CommonType Fonts</h2></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884799680"></a>Overview</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.1.1"></a>Specification</h4></div></div></div><p>This chapter outlines recommendations for creating
          CommonType fonts.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884796944"></a>Byte Ordering</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.2.1"></a>Specification</h4></div></div></div><p>All CommonType fonts use Motorola-style byte ordering (Big
          Endian).</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884794112"></a>'sfnt' Version</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.3.1"></a>Specification</h4></div></div></div><p>CommonType fonts that contain TrueType outlines should use
          the value of 1.0 for the sfnt version. CommonType fonts
          containing CFF data should use the tag 'OTTO' as the sfnt
          version number.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884791136"></a>Mixing Outline Formats</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.4.1"></a>Specification</h4></div></div></div><p>Both Microsoft and Adobe recommend against mixing
          outline formats within a single font. Choose the format that
          meets your feature requirements.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884788192"></a>Filenames</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.5.1"></a>Specification</h4></div></div></div><p>CommonType fonts may have the extension .OTF, .TTF, or .TTC,
	  ...
	  experience.</p><div class="informaltable"><table class="informaltable" border="1"><colgroup><col/><col/><col/></colgroup><thead><tr><th>Glyph ID</th><th>Glyph name</th><th>Unicode value</th></tr></thead><tbody><tr><td>0</td><td>.notdef</td><td>undefined</td></tr><tr><td>1</td><td>.null</td><td>U+0000</td></tr><tr><td>2</td><td>CR</td><td>U+000D</td></tr><tr><td>3</td><td>space</td><td>U+0020</td></tr></tbody></table></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884766224"></a>Shape of .notdef glyph</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.8.1"></a>Specification</h4></div></div></div><p>The .notdef glyph is very important for providing the
	  ...
	  not being displayed at that location.</p><div class="figure"><a name="idm79884762976"></a><p class="title"><strong>Figure 39.1. Suggested shapes of .notdef glyph</strong></p><div class="figure-contents"><div class="mediaobject"><img src="src/images/../../notdef.gif" alt="Suggested shapes of .notdef glyph"/></div></div></div><br class="figure-break"/></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884760320"></a>BASE Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.9.1"></a>Specification</h4></div></div></div><p>The <a class="link" href="chapter.BASE.html" title="Chapter 21. BASE - Baseline Table">BASE</a> table allows for different
          ...
          expected in the above situations.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884753664"></a>cmap Table </h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.10.1"></a>Specification</h4></div></div></div><p>When building a Unicode font for Windows, the platform
          ...
          according to Apple guidelines.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884743520"></a>cvt Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.11.1"></a>Specification</h4></div></div></div><p>Should be defined only if required by font
          instructions.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884740688"></a>fpgm Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.12.1"></a>Specification</h4></div></div></div><p>Should be defined only if required by TrueType font
          instructions.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884737856"></a>glyf Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.13.1"></a>Specification</h4></div></div></div><p>The <a class="link" href="chapter.glyf.html" title="Chapter 15. glyf - Glyf Data">glyf</a> table contains TrueType
          ...
          valid in embedded CommonType fonts.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884734032"></a>hdmx Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.14.1"></a>Specification</h4></div></div></div><p>This table improves the performance of CommonType fonts
          ...
          are not needed above the linearity threshold.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884724176"></a>head Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.15.1"></a>Specification</h4></div></div></div><p>Although historical usage of the fontRevision value is
          ...
          (LookupType=2).</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884708960"></a>loca Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.19.1"></a>Specification</h4></div></div></div><p>All data required for fonts with TrueType outlines. We
          ...
          Windows will expose to users.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884690112"></a>OS/2 Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.23.1"></a>Specification</h4></div></div></div><p>All data required. We recommend applying PANOSE values
          ...
          em), for example, sets sTypoLineGap = 200.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884680000"></a>post Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.24.1"></a>Specification</h4></div></div></div><p>All information required, although the VM Usage fields
          ...
          support the default names supplied on the Macintosh.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884675920"></a>prep Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.25.1"></a>Specification</h4></div></div></div><p>Should be defined only if required by the TrueType font
          instructions.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884673088"></a>VDMX Table</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.26.1"></a>Specification</h4></div></div></div><p>This table improves the performance of CommonType fonts
          ...
          this table are absent and font exceeds linear height.</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884670000"></a>Optimized Table Ordering</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.27.1"></a>Specification</h4></div></div></div><p>CommonType fonts with TrueType outlines are more efficient
          ...
          tables, as convenient)</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884664784"></a>Non-Standard (Symbol) Fonts</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.28.1"></a>Specification</h4></div></div></div><p>Non-standard fonts such as Symbol or Wingdings(tm) have
          ...
          identical if and only if:</p><p>LineGap &gt;= (yMax - yMin) - (Ascender - Descender)</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884609744"></a>Style Bits</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.31.1"></a>Specification</h4></div></div></div><p>For backwards compatibility with previous versions of
          ...
          EGA).</p></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884599840"></a>Embedded Bitmaps</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.33.1"></a>Specification</h4></div></div></div><p>Three tables are used to embed bitmaps in CommonType
          ...
          defined.</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p>These metrics are returned as part of the logical
              ...
              Typography (AAT) GetFontInfo() API.</p></li></ul></div></div></div><div role="fragment" class="section"><div class="titlepage"><div><div><h3 class="title"><a name="idm79884588704"></a>CommonType CJK Font Guidelines</h3></div></div></div><div role="specification" class="section"><div class="titlepage"><div><div><h4 class="title"><a name="section.40.34.1"></a>Specification</h4></div></div></div><p>This section provides a checklist of links to various
